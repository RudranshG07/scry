...
test("database migrations are ordered transactions without inline comments", () => {
  ...
  assert.deepEqual(names, ["001_core.sql", "002_timeseries.sql", "003_operations.sql", "004_reputation.sql", "005_evidence.sql", "006_auth.sql", "007_submitted_streams.sql", "008_claims.sql", "009_chain.sql"]);
